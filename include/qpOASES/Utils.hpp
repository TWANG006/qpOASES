...
QPOASES_API	returnValue print(const real_t* const v,	/**< Vector to be printed. */
 ...
 * \return SUCCESSFUL_RETURN */
QPOASES_API returnValue print(const real_t* const M,	/**< Matrix to be printed. */
 ...
 * \return SUCCESSFUL_RETURN */
QPOASES_API returnValue print(const int_t* const index,	/**< Index array to be printed. */
 ...
 * \return SUCCESSFUL_RETURN */
QPOASES_API returnValue myPrintf(const char* s	/**< String to be written. */
);
...
QPOASES_API returnValue readFromFile(real_t* data,				/**< Matrix to be read from file. */
	int_t nrow,					/**< Row number of matrix. */
	int_t ncol,					/**< Column number of matrix. */
 ...
 * \return SUCCESSFUL_RETURN \n
		   RET_UNABLE_TO_OPEN_FILE \n
		   RET_UNABLE_TO_READ_FILE */
QPOASES_API returnValue readFromFile(real_t* data,				/**< Vector to be read from file. */
	int_t n,					/**< Length of vector. */
	const char* datafilename	/**< Data file name. */
);
 ...
 * \return SUCCESSFUL_RETURN \n
		   RET_UNABLE_TO_OPEN_FILE \n
		   RET_UNABLE_TO_READ_FILE */
QPOASES_API returnValue readFromFile(int_t* data,				/**< Vector to be read from file. */
	int_t n,					/**< Length of vector. */
	const char* datafilename	/**< Data file name. */
);
 ...
 * \return SUCCESSFUL_RETURN \n
		   RET_UNABLE_TO_OPEN_FILE  */
QPOASES_API returnValue writeIntoFile(const real_t* const data,		/**< Matrix to be written into file. */
	int_t nrow,						/**< Row number of matrix. */
	int_t ncol,						/**< Column number of matrix. */
	const char* datafilename,		/**< Data file name. */
 ...
 * \return SUCCESSFUL_RETURN \n
		   RET_UNABLE_TO_OPEN_FILE  */
QPOASES_API returnValue writeIntoFile(const real_t* const data,		/**< Vector to be written into file. */
	int_t n,						/**< Length of vector. */
	const char* datafilename,		/**< Data file name. */
	BooleanType append = BT_FALSE	/**< Indicates if data shall be appended if the file already exists (otherwise it is overwritten). */
);
 ...
 * \return SUCCESSFUL_RETURN \n
		   RET_UNABLE_TO_OPEN_FILE */
QPOASES_API returnValue writeIntoFile(const int_t* const integer,		/**< Integer vector to be written into file. */
	int_t n,						/**< Length of vector. */
	const char* datafilename,		/**< Data file name. */
...
QPOASES_API returnValue writeIntoMatFile(FILE* const matFile,		/**< Pointer to Matlab binary file. */
...
QPOASES_API real_t getNorm(const real_t* const v,	/**< Vector. */
...
QPOASES_API returnValue getKktViolation(int_t nV,									/**< Number of variables. */
 ...
 * \return SUCCESSFUL_RETURN */
QPOASES_API returnValue convertBooleanTypeToString(BooleanType value, 		/**< Value to be written. */
 ...
 * \return SUCCESSFUL_RETURN */
QPOASES_API returnValue convertSubjectToStatusToString(SubjectToStatus value,	/**< Value to be written. */
	char* const string		/**< Input: String of sufficient size, \n
								 Output: String containing value. */
);
 ...
 * \return SUCCESSFUL_RETURN */
QPOASES_API returnValue convertPrintLevelToString(PrintLevel value, 		/**< Value to be written. */
	char* const string		/**< Input: String of sufficient size, \n
								 Output: String containing value. */
);
 ...
 */
QPOASES_API int_t getSimpleStatus(returnValue returnvalue, 				/**< ReturnValue to be analysed. */
 ...
 * \return SUCCESSFUL_RETURN \n
 *		   RET_INVALID_ARGUMENTS */
QPOASES_API returnValue normaliseConstraints(int_t nV,		/**< Number of variables. */
	int_t nC, 		/**< Number of constraints. */
